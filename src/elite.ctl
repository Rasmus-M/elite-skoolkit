...
D $6FF8 Used by the routines at #R$7222, #R$7471, #R$8F0D, #R$93C0, #R$DB62 and #R$DE67.
...
D $7119 Used by the routines at #R$E6AE, #R$EB7C and #R$EC58.
s $711C Unused
S $711C,5,$05
...
D $7FBE Used by the routines at #R$7378, #R$7471, #R$9296, #R$9341 and #R$93ED.
...
D $8080 Used by the routines at #R$7378, #R$7471, #R$9296, #R$9341 and #R$93ED.
...
R $813E A Index of jump to take
...
N $8B9C This entry point is used by the routine at #R$8B0F.
...
D $8DEE Used by the routines at #R$8B0F, #R$8B8A, #R$8C13, #R$8C96, #R$8D13, #R$8D8B, #R$9060, #R$90CC, #R$917B, #R$91F4 and #R$925F.
N $8DF3 This entry point is used by the routine at #R$90FB.
c $8E08 Routine at 8E08
D $8E08 Used by the routines at #R$8B0F, #R$8B8A, #R$8C13, #R$8C96, #R$8D13, #R$8D8B, #R$9060, #R$90CC, #R$917B, #R$91F4 and #R$925F.
...
D $9641 Used by the routine at #R$9561.
...
D $9684 Used by the routines at #R$969B and #R$96A9.
...
D $9EF1 Used by the routines at #R$9C86 and #R$9E73.
...
D $9F82 Used by the routines at #R$9CA5 and #R$9CBB.
...
D $A28D Used by the routines at #R$9CA5 and #R$9CAF.
...
D $A6AC Used by the routines at #R$A587 and #R$AE69.
...
D $AFA8 Used by the routines at #R$9C89, #R$9ECF and #R$9F18.
...
D $B799 Used by the routines at #R$A2C0, #R$A3A2, #R$A587, #R$A84D, #R$B4D8, #R$B63C, #R$B898, #R$B96B, #R$B9E7, #R$BA83, #R$BA94, #R$BBBA, #R$BBF2, #R$BC21 and #R$BC78.
...
D $B7B4 Used by the routines at #R$9C8C and #R$9CB5.
...
D $B867 Used by the routines at #R$9C9C, #R$9CBB, #R$A3A2, #R$B618 and #R$B63C.
...
B $C000,531,8*66,3
c $C213 Lenslock
D $C213 Used by the routines at #R$C24A and #R$D07C.
...
D $C2BA Used by the routines at #R$C25D, #R$C268 and #R$C414.
c $C2C9 Routine at C2C9 (lenslock)
D $C2C9 Used by the routines at #R$C268 and #R$C4FF.
...
D $C3A8 Used by the routines at #R$C226, #R$C414 and #R$C608.
c $C3AE Routine at C3AE (lenslock)
D $C3AE Used by the routines at #R$C43F and #R$C4B0.
...
D $C408 Used by the routines at #R$C268, #R$C303, #R$C3B8 and #R$C43F.
...
D $C4D0 Used by the routines at #R$C268 and #R$C43F.
...
D $C727 Used by the routines at #R$C230, #R$C414, #R$C4B0, #R$C52F and #R$C608.
...
N $D2E5 This entry point is used by the routines at #R$D32D, #R$D946, #R$DAEF, #R$E107, #R$E212, #R$EDDF and #R$EF21.
...
D $D3D3 Used by the routines at #R$D1C7, #R$E935 and #R$E973.
...
D $D3FD Used by the routines at #R$E7DB and #R$E973.
b $D420 Data block at D420
@ $D420 label=other_token_flag
B $D420,1,1
c $D421 Print token
D $D421 Used by the routines at #R$D2E1, #R$D837, #R$E107, #R$E212, #R$E2F8, #R$E31E, #R$E398, #R$E3CC, #R$E7CF, #R$E818, #R$E87E, #R$E8EA, #R$E973, #R$EB47, #R$EDDF, #R$EEA8, #R$EF87 and #R$F0A1.
...
N $D425 This entry point is used by the routines at #R$D048, #R$D357, #R$D37D, #R$D470, #R$D8F8, #R$DA7A, #R$DAEF, #R$E212, #R$E268, #R$E297, #R$E29E, #R$E2A6, #R$E2F8, #R$E306, #R$E311, #R$E31E, #R$E3E9, #R$E776, #R$E818, #R$E87E, #R$E973, #R$EEA8, #R$EECE, #R$F068 and #R$F07A.
...
D $D45F Used by the routines at #R$D039, #R$D0F6, #R$D138, #R$D470, #R$D5B4, #R$D90A, #R$D946, #R$DA5A, #R$DBA2, #R$E292, #R$E3E9, #R$E8E5, #R$EDDF, #R$EF87 and #R$F0A1.
...
D $D54F Used by the routines at #R$D90A, #R$E707, #R$E8D9, #R$E973 and #R$EC58.
...
D $D568 Used by the routines at #R$D90A, #R$E707, #R$E8D9, #R$EDDF, #R$EF48, #R$EF87 and #R$F0A1.
...
D $D5E1 Used by the routines at #R$D5B4 and #R$D885.
b $D5F5 Data block at D5F5
B $D5F5,40,8
c $D61D Clear screen with border
D $D61D Used by the routines at #R$D036, #R$D0F6, #R$D138, #R$D90A, #R$DBA2, #R$E707, #R$E973, #R$EB7C and #R$EC58.
...
N $D878 This entry point is used by the routines at #R$D82E, #R$D857, #R$D86A and #R$D8B4.
c $D87B Routine at D87B
D $D87B Used by the routine at #R$D837.
N $D87F This entry point is used by the routines at #R$D86A, #R$D872, #R$D885 and #R$D8B4.
...
D $DA16 Used by the routine at #R$D946.
c $DA25 Routine at DA25
D $DA25 Used by the routine at #R$D946.
N $DA2D This entry point is used by the routine at #R$D946.
c $DA49 Routine at DA49
D $DA49 Used by the routine at #R$D946.
c $DA53 Routine at DA53
D $DA53 Used by the routine at #R$D946.
c $DA5A Routine at DA5A
D $DA5A Used by the routines at #R$D946 and #R$DA25.
...
D $DEA2 Used by the routines at #R$DB62, #R$DC8E and #R$E973.
s $DEB9 Unused
S $DEB9,23,$17
...
D $DF60 Used by the routines at #R$DBA2, #R$DC29, #R$E3E9 and #R$EDDF.
...
D $E01C Used by the routines at #R$D857, #R$DF03, #R$DF60 and #R$ED78.
N $E063 This entry point is used by the routine at #R$DFC4.
c $E080 Routine at E080
D $E080 Used by the routines at #R$DF4C and #R$DF60.
...
D $E136 Used by the routines at #R$DF4C and #R$DF60.
...
D $E1E8 Used by the routines at #R$D0F6, #R$DA5A, #R$DAD7, #R$DBA2, #R$E398, #R$E3E9 and #R$E832.
c $E1F7 Routine at E1F7
D $E1F7 Used by the routines at #R$D0F6, #R$D90A, #R$D946, #R$E3E9, #R$E6AE, #R$E776 and #R$E973.
c $E205 Routine at E205
D $E205 Used by the routines at #R$D0F6, #R$D90A, #R$DBA2, #R$E1F7, #R$E398 and #R$E3E9.
c $E212 Routine at E212
D $E212 Used by the routines at #R$E707 and #R$EF48.
...
D $E2A6 Used by the routines at #R$D837, #R$DA7A, #R$DAEF, #R$E212, #R$E707, #R$E87E, #R$E973, #R$EE9D, #R$EF48, #R$EF87 and #R$F0A1.
N $E2A9 This entry point is used by the routines at #R$D6B9, #R$DA5A, #R$E212, #R$E2BC, #R$E3E9, #R$E8EA, #R$E973, #R$EDDF, #R$EEA2, #R$F068 and #R$F0A1.
...
D $E2BC Used by the routines at #R$D87B, #R$E212, #R$E268, #R$E707, #R$E7CF, #R$E818, #R$E973, #R$EB63, #R$EF87 and #R$F0A1.
N $E2C0 This entry point is used by the routines at #R$E973 and #R$F068.
C $E2C0,3 Get x
C $E2C3,2 End of row?
C $E2C5,1 Return if not
c $E2C8 Routine at E2C8
D $E2C8 Used by the routines at #R$D8F3, #R$E2A6, #R$E36B, #R$E973, #R$EDDF, #R$EF87 and #R$F0A1.
...
D $E2D5 Used by the routines at #R$E3E9 and #R$E76E.
c $E2F8 Routine at E2F8
D $E2F8 Used by the routines at #R$E306, #R$E3E9 and #R$EDDF.
c $E306 Routine at E306
D $E306 Used by the routines at #R$E8EA, #R$EB63, #R$EDDF, #R$EF48 and #R$F0A1.
c $E311 Routine at E311
D $E311 Used by the routines at #R$D872, #R$D8B4, #R$E398 and #R$ED78.
...
D $E35A Used by the routines at #R$E1F7 and #R$E3E9.
c $E35E Routine at E35E
D $E35E Used by the routines at #R$D0F6, #R$D81F, #R$DBA2, #R$E6AE, #R$E832 and #R$E8EA.
N $E360 This entry point is used by the routine at #R$E35A.
c $E364 Routine at E364
D $E364 Used by the routines at #R$E707 and #R$E8EA.
c $E36B Routine at E36B
D $E36B Used by the routines at #R$DA25, #R$E398, #R$E3CC, #R$E3E9, #R$E87E and #R$E973.
N $E37A This entry point is used by the routine at #R$DA5A.
c $E38D Routine at E38D
D $E38D Used by the routines at #R$E707 and #R$E8EA.
...
D $E46F Used by the routines at #R$DF4C, #R$DF60, #R$E4D4, #R$EB7C and #R$EC58.
...
D $E6FA Used by the routines at #R$E707 and #R$EF48.
...
D $E776 Used by the routines at #R$E707, #R$E8EA and #R$E973.
N $E779 This entry point is used by the routine at #R$E76E.
c $E7CF Routine at E7CF
D $E7CF Used by the routines at #R$E707, #R$E8EA and #R$E973.
...
D $E83C Used by the routines at #R$E7DB, #R$E935 and #R$E973.
c $E85D Routine at E85D
D $E85D Used by the routines at #R$E76E, #R$E776, #R$E818 and #R$E973.
c $E87E Routine at E87E
D $E87E Used by the routines at #R$E707 and #R$E8EA.
s $E8A4 Unused
S $E8A4,10,$0A
...
D $E962 Used by the routines at #R$E707 and #R$E8EA.
...
D $EB3E Used by the routines at #R$D1E9, #R$D21F, #R$E973, #R$EB2F and #R$ED78.
...
D $EF37 Used by the routines at #R$DDE3 and #R$EDDF.
...
N $F0B8 This entry point is used by the routines at #R$D018, #R$E6AE, #R$E707, #R$E8AE and #R$E8EA.
